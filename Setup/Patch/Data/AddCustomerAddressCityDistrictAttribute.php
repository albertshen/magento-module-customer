...
use AlbertMage\Directory\Model\ResourceModel\Address;
use AlbertMage\Directory\Model\ResourceModel\Address\Attribute\Backend\City;
use AlbertMage\Directory\Model\ResourceModel\Address\Attribute\Backend\District;
    ...
    public function apply()
    {
        ...
        $customerSetup->addAttribute(
            ...
            [
                ...
                'label' => 'City',
                'input' => 'hidden',
                'source' => Address\Attribute\Source\City::class,
                'required' => false,
                'sort_order' => 101,
                'position' => 101,
                'system' => 0,
        ...
        $customerSetup->addAttribute(
            ...
            [
                ...
                'label' => 'District',
                'input' => 'hidden',
                'source' => Address\Attribute\Source\District::class,
                'required' => false,
                'sort_order' => 102,
                'position' => 102,
                'system' => 0,
